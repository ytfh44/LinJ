...
Implements ChangeSet format and atomic commit as defined in LinJ specification sections 9.1, 9.2, and 20.
"""
...
class ChangeSet(BaseModel):
    ...
    def get_all_modified_paths(self) -> Set[str]:
        """Get all modified paths (written or deleted)"""
    ...
    def intersects_with(self, other: "ChangeSet") -> bool:
        ...
        Determines write/delete path intersection per section 11.4 rules
        """
...
class ChangeSetBuilder:
    ...
    Accumulates changes during node execution
    """
